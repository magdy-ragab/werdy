...
oCon.setDatabaseName("quran.db.sqlite")
oCon.open()
query = new QSqlQuery( )
...
func thePageData px
        ...
        for i=0 to (1*pagesCount())-1
                ...
                while query.movenext()
                        ...
                        ayat += "<span style='color:"+ayat_color+"'>"+  aya_text +"</span>"+ " ("+ aya_no +") " + ' '
...
func setPageData
        ...
        ayatHTML.settext('')
        ayatHTML.sethtml(LINESTART+ayat+LINEEND)
        //Remove(nfile)
...
func hiddenMode
        ...
        win1.hide()
        win1.show()
        win1.setwindowflags( qt_WindowStaysOnBottomHint)*/
